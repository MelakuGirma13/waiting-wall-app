...
These instructions are essential for ensuring accurate and helpful responses when interacting with the shadcn/studio MCP SERVER. Follow these guidelines strictly when working with shadcn/studio MCP server.
